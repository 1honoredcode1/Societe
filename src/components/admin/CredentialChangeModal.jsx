  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-100 flex items-center justify-center sm:p-4">
      <div className="bg-white sm:rounded-lg shadow-2xl w-full max-w-xl h-screen sm:h-[450px] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-pink-600 to-pink-400 text-white p-4 sm:rounded-t-lg flex items-center justify-between">
          ...
          <div className="flex flex-col items-start gap-3 p-4 overflow-y-scroll text-gray-700">
            ...
            <div className="text-sm flex gap-1 items-center">
              ...
              <Link
                ...
                target="_blank"
                className="flex gap-1 items-center text-pink-500"
              >
                click here
              ...
              {newCredential?.map((cred, index) => (
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 outline-primary rounded-md p-2 text-sm"
                  />
                </div>
              ))}
            </div>
            ...
            <div className="flex gap-2 items-start mt-2">
              <input
                ...
                className="size-4 mt-0.5 text-primary bg-gray-100"
              />
            ...
            <button
              ...
              disabled={!isChanged}
              className="mt-2 text-sm bg-pink-500 not-disabled:hover:bg-pink-700 disabled:opacity-50 text-white font-medium py-2 px-5 rounded-md"
            >
              Change Credentials
            </button>
          </div>
