    ...
    <>
      <div className=" relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
              ...
              {Array(5)
                ...
                .map((_, i) => (
                  <svg
                    ...
                    className="lucide lucide-star text-transparent fill-primary"
                    aria-hidden="true"
                  >
        ...
        <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-4 leading-tight md:leading-tight">
          Buy & Sell your{" "}
          <span className="relative bg-linear-to-r from-primary to-secondary-dull bg-clip-text text-transparent">
            Social
          ...
          <span className="relative bg-linear-to-r from-secondary to-primary-dull bg-clip-text text-transparent">
            Profiles
          </span>{" "}
          online.
        </h1>
        ...
        <p className="max-w-xl text-center text-base my-7">
          A social media marketplace for you to buy and/or sell Instagram,
          Youtube, Twitter, and more. Safe. Fast. Easy
        </p>
        ...
        >
          <label className="border border-gray-400 rounded-xl p-1 flex items-center w-full max-w-md">
            <input
