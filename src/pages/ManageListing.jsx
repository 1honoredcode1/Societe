...
const ManageListing = () => {
  ...
  // Get Listing data from edit if 'id' is provided
  useEffect(() => {
    if (!id) return;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Section title="Basic Information">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <InputField
                ...
                placeholder="e.g., Premium Travel Instagrma Account"
          ...
          <div className="flex justify-end gap-3 text-sm">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-primary-dull text-white rounded-lg hover:bg-primary transition-colors"
            >
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full rounded-md border border-gray-300 px-3 py-1.5 text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary"
        required={required}
      />
    </div>
  );
