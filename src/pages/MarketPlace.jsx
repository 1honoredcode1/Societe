...
const MarketPlace = () => {
  ...
  const filteredListings = listings.filter((listing) => {
    ...
    return (
      ...
      listing.platform?.toLowerCase().includes(search) ||
      listing.niche?.toLowerCase().includes(search) ||
      listing.username?.toLowerCase().includes(search) ||
  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start justify-between relative gap-8 pb-8">
        <FilterSidebar
